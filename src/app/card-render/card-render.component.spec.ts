...
describe('CardRenderComponent', () => {
  ...
  describe('component', () => {
    it('should render CardSimpleComponent', () => {
      const cardItem: ICardItem = { ...mockCardItem, component: 'card-simple' };
    ...
    it('should render CardDoubleComponent', () => {
      const cardItem: ICardItem = { ...mockCardItem, component: 'card-double' };
      component.cardItem = (() => cardItem) as InputSignal<ICardItem>;
  ...
  describe('inputs', () => {
    ...
    it('should return inputs for known component', () => {
      const cardItem: ICardItem = { ...mockCardItem, inputs: { key: 'value' } };
      component.cardItem = (() => cardItem) as InputSignal<ICardItem>;
